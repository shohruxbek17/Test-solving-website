...
class Profile(models.Model):
    ...
    # Add additional fields for your profile here
...
class SolveProfile(models.Model):
    ...
    def get_rankings(cls):
        rankings = SolveProfile.objects.select_related(
            'user',
        ).annotate(
...
class AttemptedQuestion(TimeStampedModel):
    ...
    quiz_profile = models.ForeignKey(SolveProfile, on_delete=models.CASCADE, related_name='attempts')
